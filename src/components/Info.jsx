      ...
      <div className={styles.container}>
        ...
        <section>
          ...
          <p className={styles.description}>
            ...
            “feminist ideals, lead societal change, eliminate discrimination,
            and achieve and protect the equal rights of all women and girls in
            all aspects of social, political, and economic life.” Think:
            eliminating harassment in society, reproductive rights and ending
        ...
        <section>
          ...
          <p className={styles.description}>
            ...
            violence and discrimination against women and girls around the
            world."
          </p>
        </section>
        <section>
          ...
          <p className={styles.description}>
            ...
            in constitutional, international, and comparative human rights
            law—has transformed how reproductive rights are understood by
            courts, governments, and human rights bodies. "Through our work
            across five continents, we have played a critical role in securing
            legal victories before national courts, United Nations Committees,
            and regional human rights bodies on reproductive rights issues
            including access to life-saving obstetrics care, contraception,
            maternal health, and safe abortion services, as well as the
            prevention of forced sterilization and child marriage."
          </p>
        </section>
      </div>
      <Footer />
